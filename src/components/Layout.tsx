...
const socialLinks = [
  {
    href: 'https://www.linkedin.com/company/lionhealthcu/posts/?feedView=all',
    label: 'LinkedIn',
    icon: (
  ...
  {
    href: 'https://www.instagram.com/lionhealth.cu/?hl=en',
    label: 'Instagram',
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="container">
          <div className="nav-inner">
            <Link to="/" className="brand" onClick={closeMobileMenu}>
              <img src="/assets/logo.png" alt="LionHealth logo" className="brand-logo" />
      ...
      <footer className="footer">
        <div className="container">
          <div className="footer-inner">
            <span>© {new Date().getFullYear()} LionHealth</span>
